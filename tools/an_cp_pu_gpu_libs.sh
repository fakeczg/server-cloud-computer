...
FILES=(
	...
	"vendor/egl/libEGL_FTG340.so"
	"vendor/egl/libGLESv1_CM_FTG340.so"
	"vendor/egl/libGLESv2_FTG340.so"
	"vendor/hw/gralloc.FTG340.so"
	"vendor/libdrm_android.so"
	"vendor/libdrm_ftg340.so"
	"vendor/libdrm_vivante.so"
	"vendor/libGAL.so"
	"vendor/libGLSLC.so"
	"vendor/libVSC.so"
)
